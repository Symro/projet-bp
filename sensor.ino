...
void sendAlert(String text, int state) {
  text = text + state;
  //Serial.println(text);
  Serial.println(ip + "/arduino/?text=Mr%20Mroczko%20chambre%2023%20etat%20" + state);
  WebRequest(ip + "/arduino/?text=Mr%20Mroczko%20chambre%2023%20etat%20" + state);
}
...
void sendAlert(String text, int state) {
  text = text + state;
  //Serial.println(text);
  Serial.println("192.168.1.54/arduino/?text=Mr%20Mroczko%20chambre%2023%20etat%201");
  WebRequest("192.168.1.54/arduino/?text=Mr%20Mroczko%20chambre%2023%20etat%201");
}
